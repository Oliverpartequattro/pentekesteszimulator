...
namespace Pentekesteszimulator
{
    internal partial class Program
    {
        ...
        public static void FantasyWorld2()
        {
            ...
            int choice = Display("Bágyogszováti Temető", "Elsötétedett a világ, és hirtelen a Bágyogszováti Temetőben találod magad.", " ", "Mit teszel?",  player, timeStopped, options);
        ...
        public static void FantasyWorld3()
        {
            ...
            int choice = Display("Down-Kóros Delfin Horgászbolt", "Elsötétedett a világ, és hirtelen a Down-Kóros Delfin Horgászboltban találod magad.", " ", "Mit teszel?",  player, timeStopped, options);
        ...
        public static void FantasyWorld4()
        {
            ...
            int choice = Display("Retek Taverna", "Elsötétedett a világ, és hirtelen a Retek Tavernában találod magad.", " ", "Mit teszel?",  player, timeStopped, options);
        ...
        public static void FantasyWorld5()
        {
            ...
            int choice = Display("Purgatórium", "Elsötétedett a világ, és hirtelen a Purgatóriumban találod magad.", " ", "Mit teszel?",  player, timeStopped, options);
